                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2">
                                ...
                                <a href="{{ route('hr.mes_stagiaires.stagiaire.attestation',$stagiaire->id) }}"> Upload attestation </a>
                            ...
                            <td class="border px-4 py-2">
                                <form action="{{ route('hr.mes_stagiaires.supprimer',$stagiaire->id) }}" method="POST" class="inline-block">
                                    @csrf
