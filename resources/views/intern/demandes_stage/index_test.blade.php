            ...
            <table class="table-fixed w-full">
                <thead>
                    <tr class="bg-gray-100">
                        <th class="px-4 py-2 w-20">CV</th>
                        <th class="px-4 py-2">Lettre de motivation</th>
                        <th class="px-4 py-2">Statut de la demande</th>
                        <th class="px-4 py-2">Offre de stage</th>
                    </tr>
                </thead>
                <tbody>
                    <?php $count = 1; ?>
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2">
                            ...
                            <button wire:click="delete({{ $category->id }})" class="inline-flex items-center justify-center px-4 py-2 bg-red-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-500 focus:outline-none focus:border-red-700 focus:shadow-outline-red active:bg-red-600 transition ease-in-out duration-150">
                                Delete
                            </button>
                        </td>
                    </tr>
