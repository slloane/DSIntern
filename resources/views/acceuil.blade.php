    ...
    <div class="container">
      ...
      <nav class="navbar">
        ...
        <ul class="navbar-list">
          ...
          <li>
            <a href="#" class="navbar-link">Offres de stage</a>
          </li>

          <li>
            <a href="#" class="navbar-link">A Propos De Nous</a>
          </li>
  ...
  <main>
    <article>
      ...
      <section class="section hero" >
        ...
        <div class="container">
        <img src="{{asset('images/intern.png')}}"  alt="intern" class="intern">


          <img src="{{asset('images/ministere.png')}}"  alt="Logo ministere" class="ministere">

          <!--img src="{{ asset('dist/images/shape-2.png') }}" width="56" height="74" alt="Vector Shape" class="shape shape-2">

          <img src="{{ asset('dist/images/shape-2.png') }}shape-3.png" width="57" height="72" alt="Vector Shape" class="shape shape-3"!-->

          <div class="hero-content">

            <!--p class="section-subtitle">Explore Your Travel</p-->

            <h2 class="hero-title">Devenez stagiaire chez DSI</h2>

            <p class="hero-text">
              La DSI est la Direction du système d'information du Ministère de l'Education Nationale, du Préscolaire & des Sports. 
              Elle est responsable de concevoir, mettre en place et suivre le système d'information statistique du Ministère.
              Ainsi elle a souvent besoin des stagiaires informaticiens pour répondre à certain besoins métiers.
              Allez-y, Inscrivez-vous et trouvez l'offre de stage qui vous convient.
    ...
    <div class="container">
      ...
      <div class="footer-top">
        ...
        <ul class="footer-list">
          ...
          <li>
            <p class="footer-list-title">Rapides liens</p>
          </li>
          ...
          <li>
            <a href="#" class="footer-link">Termes et Conditions</a>
          </li>
      ...
      <div class="footer-bottom">
        ...
        <a href="#" class="logo">DSIntern</a>

        <p class="copyright">
          &copy; 2022 <a href="#" class="copyright-link">slloane</a>. All Rights Reserved
        </p>
